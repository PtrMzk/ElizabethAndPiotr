        ...
        this.state = {
            images: [
                ...
                , new this.ImageWrapper(Bruins2011, "In college, Piotr introduced Elizabeth to hockey! " +
                    "That year, they celebrated the Bruin's Stanley Cup win!", 2011)
                ...
                , new this.ImageWrapper(Graduation2014, "Piotr encouraged Elizabeth throughout graduate school.", 2014)
                ...
                , new this.ImageWrapper(Brooklyner2015, "They moved into their new apartment and discovered the joys of having a roof deck.", 2015)
                ...
                , new this.ImageWrapper(NYE2017, "Elizabeth & Piotr rang in 2017 with family and friends. Piotr said it would be their best year yet!", 2017)
